...
class CInvoiceAttention extends CDpObject {
    public $invoice_attention_id;
    public $invoice_id;
    public $attention_id;
    public function CInvoiceAttention() {
            $this-> CDpObject("sales_invoice_attention", "invoice_attention_id");
    }
