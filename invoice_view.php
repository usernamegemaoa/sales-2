...
function _form_info(){
    ...
    echo '<br><br>';
    echo $tittle_block = $AppUI ->createBlock('div_supplier','Supplier’s Name','style="float: left; margin-left : 45%"');
    echo '<br>';
    echo $tittle_block = $AppUI ->createBlock('div_1','Supplier’s Address','style="float: left; margin-left : 45%"');
    echo '<br>';
    echo $tittle_block = $AppUI ->createBlock('div_2','Supplier’s phone, fax, email, website','style="float: left; margin-left : 45%"');
    echo '<br>';
    echo $tittle_block = $AppUI ->createBlock('div_3','Reg No: Supplier’s reg no','style="float: left; margin-left : 45%"');
    echo '<br>';
    echo $tittle_block = $AppUI ->createBlock('div_4','GST Reg No:Supplier’s GST reg no','style="float: left; margin-left : 45%"');
...
function _form_new() {
    ...
    $demonstrationSection = new JFormSection($demonstrationForm->id . 'Section');
     ...
     echo $quo = $AppUI ->createBlock('div_no',$quo_no,'style="float: left; margin-left : 45%"');
     echo '<br>';
